...
const ProductDetails: FC<ProductDetailsProps> = ({
  ...
  console.log('params data is',data);
...
//  console.log(form.handleSubmit);
  ...
  useEffect(() => {
    ...
    form.setValue("saleEndDate",saleEndDate);
  }, [data, form]);
  ...
  const handleSubmit2 = async (values: z.infer<typeof ProductFormSchema>) => {
    alert('2');
    try {
      console.log("handlesubmit entered",values);
      // Upserting product data
      const val:ProductWithVariantType = {
...
// }, [colors, sizes, keywords, data]);
  ...
  // const handleSetImages = (field: any, url:string) => {
    ...
    <AlertDialog>
      <Card className="w-full">
        ...
        <CardContent>
          <Form {...form}>
            <form
              onSubmit={form.handleSubmit(handleSubmit2, handleSubmit1)}
              className="space-y-4"
            >
              {/* Images - colors */}
                      ...
                      <FormControl>
                        <div>
                          ...
                          <ImageUpload
                            ...
                            // disabled={isLoading}
                            onChange={(url) => {
                              let updatedImages:Array<{url:string}>=[];
                              setImages((prevImages) => {
                                updatedImages = [...prevImages, { url }];
                                return updatedImages;
                              });
                              field.onChange(updatedImages);
                            }}
