...
const ImageUpload: FC<ImageUploadProps> =({
    ...
    if(type==="profile"){
           ...
           <div className="relative rounded-full w-52 h-52  bg-gray-200 border-2 border-white shadow-2xl overflow-visible">
            {
                ...
                width={300} 
                height={300} 
                className="w-52 h-52 roudned-full object-cover absolute top-0 left-0 bottom-0 right-0"
                />
            
            }
            <CldUploadWidget uploadPreset="adadad" onSuccess={onUpload}>
            {({open }) => {
                const onClick = () => {
                    open();
                };
        ...
        return <div className="relative w-full bg-gra-100 rounded-lg bg-gradient-to-b from-gray-100 via-gray-100 to-gray-400 overflow-hidden"
        style={{ height: "348px" }}
        >
        {value.length > 0 && (
            <Image
        ...
        <CldUploadWidget onSuccess={onUpload} uploadPreset="adadad">
            {({ open }) => {
                const onClick = () => {
                    open();
                };
