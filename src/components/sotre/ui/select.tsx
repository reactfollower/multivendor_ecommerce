...
const Select: FC<Props> = ({
    ...
    const handleOptionClick = (option: string) => {
        onChange(value);
        setActiveVariant(options.find((o)=> o.value === options));
        setIsOpen(false);
    };
    return (
        <div className="relative w-full z-50">
            <div>
                <div className="relative">
                  ...
                  <input 
                    className={cn(
                        "w-full pr-6 pl-8 py-4 roudned-xl outline-none duration-200",
                        {
                            "ring-1 ring-[transparent] foucs:ring-[#11BE86]":
            ...
            {isOpen && (
                <div className="absolute top-16 w-full left-0 rounded-xl border p-4 bg-white shadow-lg">
                    ...
                    <ul className="flex gap-w flex-col mt-2">
                            ...
                            <li  
                              ...
                              >
                                {option.image && <Image
                                 ...
                                 width={100}
                                 height={100}
                                 className="w-10 h-10 roudned-full shadow-md object-top object-cover"
                                />}
                                {option.name}
                              </li>
                        ))}
