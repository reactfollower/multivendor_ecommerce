...
export default function CountryLanguageCurrencySelector({
    ...
    return (
        <div className="relative inline-block group">
          ...
          <div>
            <div className="flex items-center h-11 py-0 px-2 cursor-pointer">
                <span className="mr-0.5 h-[33px] grid place-items-center">
                    <span className={`fi fi-${userCountry.code.toLocaleLowerCase()}`}></span>
                </span>
                <div className="ml-1">
          ...
          {/* Content */}
          <div className="absolute hidden top-0 group-hover:block curosr-pointer">
            <div className="relative mt-12 -ml-32 w-[300px]  bg-white rounded-[24px] text-main-primary pt-2 px-6 pb-6 z-50 shadow-lg">
            {/* Triangle */}
            <div
              className="w-0 h-0 absolute -top-1.5 right-24 border-1 transparent border-b-[10px] border-white border-r-[10px] border-r-transprent" />
