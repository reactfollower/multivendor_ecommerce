...
export default function CategoriesMenu({
  ...
  // console.log(categories);
   return (
      <div className="relative w-10 h-10 xl:w-[256px] z-50"
     ...
     <div className="relative">
       ...
       <ul
          className={cn(
            "absolute top-10 left-0 w-[256px] bg-[#f5f5f5] shadow-lg transition-all duration-100 ease-in-out scrollbar overflow-y-auto max-h-[200px]",
              {
